 ...
 * POST /api/admin/deposit-action - Perform actions on deposits
 * Body: { depositId, action, amount? }
...
export default async function handler(req, res) {
  ...
  try {
    const { depositId, action, amount } = req.body;
    ...
    console.error(`❌ Admin ${req.body?.action} action failed:`, error);
